...
exports.usePipeEffects = exports.createEffects = exports.declareActions = exports.effectable = exports.EffectProvider = void 0;
...
var Provider = EffectsContext.Provider,
    Consumer = EffectsContext.Consumer;
  ...
  var _class_ = function _class_(Target) {
    ...
    function (_Component) {
      ...
      function Effect(props) {
        ...
        var _createEffectsManager = createEffectsManager(props.declareActions || props.actions, props.effects, props.subscribes),
...
var usePipeEffects = function usePipeEffects(_temp2) {
  var _ref2 = _temp2 === void 0 ? {} : _temp2,
      declaredActions = _ref2.declaredActions,
      actions = _ref2.actions,
      effects = _ref2.effects,
      subscribes = _ref2.subscribes,
      _ref2$autoRun = _ref2.autoRun,
      autoRun = _ref2$autoRun === void 0 ? true : _ref2$autoRun;

  var context = _react.default.useContext(EffectsContext) || {};
  declaredActions = declaredActions || actions || context.declaredActions || context.actions;
