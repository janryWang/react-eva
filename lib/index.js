  ...
  return function (Target) {
    ...
    function (_Component) {
      ...
      function Effect(props) {
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createStateAction", function (name, fn) {
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createEffectSource", function () {
      ...
      _proto.render = function render() {
        var _this$props = this.props,
            ...
            props = _objectWithoutPropertiesLoose(_this$props, ["actions", "effects"]);
