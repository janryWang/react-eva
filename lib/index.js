...
exports.useXEffect = exports.createEffects = exports.createActions = exports.connect = void 0;
...
var createEffectsManager = function createEffectsManager(actions, effects, subscribes) {
  ...
  var _class_ = function _class_(Target) {
    ...
    function (_Component) {
      ...
      function Effect(props) {
        ...
        var _createEffectsManager = createEffectsManager(props.actions, props.effects, props.subscribes),
...
var useXEffect = function useXEffect(_temp) {
  ...
  return _react.default.useMemo(function () {
    var manager = createEffectsManager(actions, effects, subscribes);
